...
//--[2018-04-09] Prefix path values from editorial
if(_preprocess.subdoms.indexOf('editorial')>-1 && mpscall.path.indexOf('EDITORIAL:')<0){
  mpscall.path='EDITORIAL:'+'/'+mps._trim(mpscall.path,'/');
  mpscall["cag[system]"]='editorial';
}
...
mps.hb.a9pubid = '3219';
mps.hb.mgid = '24610';
mps.hb.dvid = '24187061/DV1473088';
